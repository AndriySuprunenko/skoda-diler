    ...
    <x-section>
        <x-Text.title>Опис моделі</x-Text.subtitle>
            <x-Text.text class="mb-6">
                Fabia - це компактний автомобіль від Škoda, який поєднує в собі стиль, комфорт та передові технології.
                Цей
                автомобіль ідеально підходить для міських умов, забезпечуючи високу маневреність та зручність
                використання.
                Fabia пропонує широкий вибір двигунів, включаючи гібридні варіанти, що забезпечують високу ефективність
            ...
            <x-Text.text>
                Fabia також оснащений найсучаснішими системами безпеки та допомоги водієві, такими як адаптивний
